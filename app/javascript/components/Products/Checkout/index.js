      ...
      <div className="row">
            ...
            <form>
              <div className="row">
                <div className="col-50">
                  ...
                  <label for="name"><i className="fa fa-user"></i> Nome Completo</label>
                  <input
                    type="text"
                    id="name"
                    name="firstname"
                  ...
                  />
                  <label for="end"
                  ><i className="fa fa-address-card-o"></i> Endereço</label
                  >
                  <input
                    type="text"
                    id="end"
                  ...
                  />
                  <label for="city"><i className="fa fa-institution"></i> Cidade</label>
                  <input
                    type="text"
                    id="city"
                    name="city"
        ...
        <div className="col-25">
          <div className="container">
            ...
            <p><a>{props.data.products.name}</a> <span className="price">R$ {props.data.products.price}</span></p>
          <hr />
          <p>
              Total <span className="price" style={{ color: "black" }}><b>R$ {props.data.products.price}</b></span>
          </p>
        </div>
      </div>
    </div>
